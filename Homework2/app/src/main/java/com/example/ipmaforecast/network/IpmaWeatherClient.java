...
public class IpmaWeatherClient {
     ...
     * @param listener a listener object to callback with the results
     */
    public void retrieveWeatherConditionsDescriptions(com.example.ipmaforecast.network.WeatherTypesResultsObserver listener) {
     ...
     * @param listener a listener object to callback with the results
     */
    public void retrieveForecastForCity(int localId, com.example.ipmaforecast.network.ForecastForACityResultsObserver listener) {
